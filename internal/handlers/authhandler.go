...
func OAuthCallback(w http.ResponseWriter, r *http.Request) {
	...
	case "/auth/google/callback":
		...
		clientURL = "https://www.googleapis.com/oauth2/v2/userinfo"
	case "/auth/github/callback":
		oauth2Config = githubOauthConfig
		clientURL = "https://api.github.com/user/emails"
	case "/auth/facebook/callback":
		oauth2Config = facebookOauthConfig
		clientURL = "https://graph.facebook.com/me?fields=id,name,email"
	}
	...
	userInfo, err := client.Get(clientURL)
	if err != nil {
